...
% lat = urban(:,18);lon = urban(:,17);p = urban(:,4);scatter(lon,lat,10,p,'filled')

% indoor = [DadiCinimaRoom7;FamilyMart;Hotel18thFloor;HotelLobby;HSRonBoard;HSRStation;IndoorMovingGrandOrientalAF12345;IndoorMovingGrandOrientalB;IndoorMovingYunfu;IndoorSunningPlazaMix;IndoorSunningPlazaStationary;MovingHotelLobby;NanjingBank;StationaryHotelF18;StationaryHotelLobby;YunfuIndF123;YunfuIndF35;YunfuIndF4;YunfuIndF6;YunfuIndF7;YunfuIndoorStationary];
% outdoor = [FuxingRoadOutdoor;MovingOut;OutdoorMoving;OutdoorSanyangPlaza;OutdoorStationary;SanyangPlaza;Station2HotelOutdoor;StationayOut;Yunfu2HotelWalk;YunfuOut];
% lat1 = indoor(:,18);lon1 = indoor(:,17);p1 = indoor(:,4);gscatter(lon1,lat1,p1,hot);hold on;
% lat2 = outdoor(:,18);lon2 = outdoor(:,17);p2 = outdoor(:,4);gscatter(lon2,lat2,p2,cold);
