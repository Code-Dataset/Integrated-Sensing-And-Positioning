...
function [Ellipse confidence SimilarMeasurements numAllMeasurements errorCode]=iAecidMain_0(positioningRequest, measurements, criteria, cellInfo, googlemap)
...
tic;
t1=clock;
[initMeasurements similarity weightedCell]=PointsInitiation_0(positioningRequest, measurements, 1, criteria, cellInfo);  % 初筛(邻区数量、RSRP)  计算相似度(微调 惩罚)
tic;
t2=clock;
etime(t2,t1);
