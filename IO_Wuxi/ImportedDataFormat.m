...
CELL_LON=2;
CELL_ID=3;
CELL_ACCMIN=4;%ACCMIN for GSM or qRxLevMin
CELL_ANTENNA_TYPE=5; %0 for OMNI and 1 for SECTOR and -1 for indoor
CELL_BSPWR=6;
CELL_SYS_TYPE=7; %0 for GSM800, 1 for GSM1900, 2 for 3G 800, 3 for 3G 1900
CELL_DIR=8; 
CELL_SECTOR_ANGLE=9; %
CELL_HEIGHT=10;
CELL_DOWNTILT=11; % Elec tilt
CELL_BEAMWIDTH_H=12;
CELL_BEAMWIDTH_V=13;
CELL_SC=14; % SC or PCI
CELL_UARFCN=15; % or EARFCN DL
CELL_LAC=16;
CELL_TILT_M=17;
% CELL_RADIUS=18; 
...
SS_RSRQ         =       [21 22 23 24 25 26 27];
NB_RSRP         =       SS_COL(2:end);
NB_RSRQ         =       SS_RSRQ(2:end);
RSTP            =       28;
% TA              =       29;
%BAND            =       29;
DL_FREQ         =       29; % Leo
